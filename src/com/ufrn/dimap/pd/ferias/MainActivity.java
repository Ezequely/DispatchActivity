...
import com.ufrn.dimap.pd.ferias.R;
import com.ufrn.dimap.pd.ferias.GPSTracker;
import com.ufrn.dimap.pd.ferias.Place;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    postsView.setOnItemClickListener(new OnItemClickListener() {
	      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
	        ...
	        map.animateCamera(CameraUpdateFactory.newLatLng(new LatLng(item.getLocation().getLatitude(), item
					...
					public boolean onMarkerClick(final Marker arg0) {
					  ...
					  if(!(arg0.getTitle().isEmpty())){
						  new AlertDialog.Builder(MainActivity.this)
						    ...
						    .setMessage("Nome: "+arg0.getTitle()+"\nEndereço:" +
						    				arg0.getSnippet()+"")
						    .setNeutralButton("Favoritar", new DialogInterface.OnClickListener() {
						        public void onClick(DialogInterface dialog, int which) { 
						            // continue with delete
						        	ParseObject favorito = new ParseObject("favorito");
						        	ParseGeoPoint point = new ParseGeoPoint(arg0.getPosition().latitude, arg0.getPosition().longitude);
						        	favorito.put("nome", arg0.getTitle());
						        	favorito.put("endereco", arg0.getSnippet());
						        	favorito.put("GeoPoint", point);
						        	favorito.increment("score");
						        	favorito.saveInBackground();
					              }
						     })
						    .setIcon(R.drawable.common_signin_btn_icon_light)
						     .show();
	                      return true;
					  }
					return false;
