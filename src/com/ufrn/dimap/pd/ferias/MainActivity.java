	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		postsView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				map.animateCamera(CameraUpdateFactory.newLatLng(new LatLng(item
						.getLocation().getLatitude(), item.getLocation()
						.getLongitude())), new CancelableCallback() {
				...
				alert.setPositiveButton("Post",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								// Set the location to the current user's
								// location
	...
	private class GetPlaces extends AsyncTask<Void, Void, ArrayList<Place>>
		...
		protected void onPostExecute(ArrayList<Place> result) {
								...
								.setNeutralButton("Favoritar",
										new DialogInterface.OnClickListener() {
											public void onClick(
												...
												ParseObject favorito = new ParseObject(
														"favorito");
			...
			CameraPosition cameraPosition = new CameraPosition.Builder()
					.target(new LatLng(my.getLatitude(), my.getLongitude())) // Sets
																				// the
																				// center
																				// of
																				// the
